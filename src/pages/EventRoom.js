          ...
          <div className="room_infos flex flex-col bg-[#e1eafc33] sm:pt-4  flex-1 justify-around	">
            <div className="flex flex-col">
              ...
              <div className="flex flex-col sm:flex-row sm:justify-around">
                <button className="bg-[#54c776] pt-2 pb-2 pr-10 pl-10 mb-2 sm:mb-0 rounded-md text-white font-bold text-lg ml-1 mr-1 hover:bg-[#41a65f] transition ease-in-out ">
                  Aralık Ekle
                </button>
