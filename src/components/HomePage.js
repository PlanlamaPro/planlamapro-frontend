...
const HomePage = () => {
  return (
    <div class='bg'>
      ...
      <div class='header1'>
        <h1 class='ortak h2'>PlanlamaPro</h1>
        <button class='login-btn ortak color'>Oturum aç</button>
        <button class='register-btn ortak'>Kaydol</button>
        <br></br>
      </div>

      <div class='div_bg bground1'>
        <h1 className='h1'>PlanlamaPro ile etkinliklerinizi kolayca planlayın!</h1>
        <p>
